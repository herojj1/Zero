# =============================================================================
# NOVA Bot — Complete Single-File Source (v5.1.1)
# =============================================================================
# v5.1.1: /sh and /msh commands now live ONLY inside the Gates button menu.
#         Tools menu no longer exposes any Shopify command buttons.
#         Old design restored everywhere else.
...
async def cmd_diag(event):
    ...
    lines.append(f"📦 Version: <code>v5.1.1</code>")
...
async def main():
    ...
    log_system("BOOT", "Starting NOVA bot v5.1.1 (API-LESS)...")
