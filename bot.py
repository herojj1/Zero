# =============================================================================
# NOVA Bot — Complete Single-File Source (v4.3.0)
# =============================================================================
# Changelog v4.3.0 (from v4.2.0):
#   - Mass check now sends 5 SEPARATE .txt files at completion:
#       CHARGED_*.txt / APPROVED_*.txt / 3DS_*.txt / DECLINED_*.txt / ERRORS_*.txt
#   - Files sent even when a category is empty (shows 0 count)
#   - Each file has clean header + summary footer
...
#   - _proxy_str_for_api() URL-encodes credentials
...
#   - Force-join checks BOTH channel AND group strictly
...
async def main():
    ...
    try:
        ...
        pass
    log_system("BOOT", "Starting NOVA bot v4.3.0...")
    if not BOT_TOKEN:
