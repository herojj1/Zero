# =============================================================================
# NOVA Bot — Complete Single-File Source (v4.0.0)
# =============================================================================
...
SHOPIFY_API_URL  = os.getenv("SHOPIFY_API_URL",
    "https://shopify-api-production-90e8.up.railway.app/check")
...
async def start_mass_rz(user_id: int, cards: list, event, status_msg):
    ...
    try:
        ...
        try:
            ...
            pass        RAZORPAY_RESULTS[user_id] = results
...
async def main():
    ...
    try:
        ...
        pass
    log_system("BOOT", "Starting NOVA bot v4.0.0...")
    if not BOT_TOKEN:
