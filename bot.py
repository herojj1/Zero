# =============================================================================
# NOVA Bot — Complete Single-File Source (v3.5)
# API: https://shopify-api-production-d377.up.railway.app/check
# Colored buttons, real per-user concurrency, cached IO, real-time redeem logs
# v3.5: Full card in progress UI, hit-rate %, ETA, fancy progress bar
# =============================================================================
...
PREMIUM_EMOJI_IDS = {
    ...
    "📮":"5444889156792646660","🟠":"5039808285478224750",
    "🔵":"5042290883949495533","🟡":"5042036407137207122",
}
...
BUTTON_ICONS = {
    ...
    "📢":"5447644880824181073","👥":"5443038326535759644",
    "🟢":"5039928501612839813","🔵":"5042290883949495533",
    "🟡":"5042036407137207122","🟠":"5039808285478224750",
    "📩":"5443127283898405358",
}
...
# ====================== PROGRESS UI (v3.5 UPDATED) ======================
def _fmt_eta(seconds: float) -> str:
    """Format ETA in a short readable form."""
...
async def test_site_with_price(site: str, proxy: str = None) -> dict:
    ...
    try:
        ...
        if sc in ('PROXY_REQUIRED', 'PROXY_INVALID'):
            return {'site': site, 'status': 'unknown', 'price': 0.0, 'response': sc}
        ...
        if is_site_error(response):
            return {'site': site, 'status': 'dead', 'price': 0.0, 'response': response[:60]}
        ...
        return {'site': site, 'status': 'unknown', 'price': 0.0, 'response': str(e)[:50]}
...
<code>/site</code> ━ {bs('Check & remove dead')}
...
<code>/getsites</code> · <code>/setthreshold 10</code> · <code>/getthreshold</code>
{SEP}
<b>📊 Bot</b>
...
async def main():
    ...
    try:
        ...
        pass
    log_system("BOOT", "Starting NOVA bot v3.5...")
    if not BOT_TOKEN:
