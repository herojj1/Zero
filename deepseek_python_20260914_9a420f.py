# =============================================================================
# NOVA Bot — Complete Single-File Source (v4.6.0)
# =============================================================================
...
#
# Changelog v4.3.0:
#   - 5 separate .txt files sent at check completion
#   - Force-join IDs set: Group=-1003902938287, Channel=-1004381920430
#
# Changelog v4.2.0:
#   - API compat: Gate field, retryable, URL-encoded proxy
...
def _write_result_file(fname: str, title: str, items: list, gateway: str = "Shopify"):
    """Write a single result file with header, cards, and footer."""
    try:
...
async def cmd_version(event):
    ...
    await styled_reply(event, pe(
        ...
        f"🔗 API: <code>{SHOPIFY_API_URL}</code>"
    ))
...
async def cmd_diag(event):
    ...
    lines.append(f"📦 Version: <code>v4.6.0</code>")
...
async def main():
    ...
    try:
        ...
        pass
    log_system("BOOT", "Starting NOVA bot v4.6.0...")
    if not BOT_TOKEN:
