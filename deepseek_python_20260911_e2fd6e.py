...
async def cmd_rmproxy(event):
    ...
    parsed = parse_proxy_format(parts[1].strip())
    if not parsed:
        return await styled_reply(event, pe(f"💎 <b>{bs('Invalid format')}</b>"))
    norm = f"{parsed['ip']}:{parsed['port']}"
    proxies = load_user_proxies(uid)
...
# ====================== FAKE DATA (50+ countries) ======================
FAKE_DATA = {
    'US': {'name':'United States','flag':'🇺🇸','phone_code':'+1','len':10,
    ...
    'GB': {'name':'United Kingdom','flag':'🇬🇧','phone_code':'+44','len':10,
    ...
    'CA': {'name':'Canada','flag':'🇨🇦','phone_code':'+1','len':10,
    ...
    'AU': {'name':'Australia','flag':'🇦🇺','phone_code':'+61','len':9,
    ...
    'DE': {'name':'Germany','flag':'🇩🇪','phone_code':'+49','len':11,
    ...
    'FR': {'name':'France','flag':'🇫🇷','phone_code':'+33','len':9,
    ...
    'IT': {'name':'Italy','flag':'🇮🇹','phone_code':'+39','len':10,
    ...
    'ES': {'name':'Spain','flag':'🇪🇸','phone_code':'+34','len':9,
    ...
    'NL': {'name':'Netherlands','flag':'🇳🇱','phone_code':'+31','len':9,
    ...
    'SE': {'name':'Sweden','flag':'🇸🇪','phone_code':'+46','len':9,
    ...
    'NO': {'name':'Norway','flag':'🇳🇴','phone_code':'+47','len':8,
    ...
    'DK': {'name':'Denmark','flag':'🇩🇰','phone_code':'+45','len':8,
    ...
    'FI': {'name':'Finland','flag':'🇫🇮','phone_code':'+358','len':9,
    ...
    'IE': {'name':'Ireland','flag':'🇮🇪','phone_code':'+353','len':9,
    ...
    'PT': {'name':'Portugal','flag':'🇵🇹','phone_code':'+351','len':9,
    ...
    'PL': {'name':'Poland','flag':'🇵🇱','phone_code':'+48','len':9,
    ...
    'IN': {'name':'India','flag':'🇮🇳','phone_code':'+91','len':10,
    ...
    'PK': {'name':'Pakistan','flag':'🇵🇰','phone_code':'+92','len':10,
    ...
    'BD': {'name':'Bangladesh','flag':'🇧🇩','phone_code':'+880','len':10,
        ...
        'last':['Islam','Hossain','Ahmed','Rahman','Khan','Chowdhury','Akter','Begum','Sarker',
                'Mia','Sheikh','Talukder']},
    'CN': {'name':'China','flag':'🇨🇳','phone_code':'+86','len':11,
    ...
    'JP': {'name':'Japan','flag':'🇯🇵','phone_code':'+81','len':10,
    ...
    'KR': {'name':'South Korea','flag':'🇰🇷','phone_code':'+82','len':10,
    ...
    'TH': {'name':'Thailand','flag':'🇹🇭','phone_code':'+66','len':9,
    ...
    'VN': {'name':'Vietnam','flag':'🇻🇳','phone_code':'+84','len':9,
    ...
    'MY': {'name':'Malaysia','flag':'🇲🇾','phone_code':'+60','len':9,
        ...
        'last':['Abdullah','Ibrahim','Hassan','Ismail','Yusof','Rahman','Halim','Karim','Razak',
                'Jaafar','Aziz','Rahim']},
    'SG': {'name':'Singapore','flag':'🇸🇬','phone_code':'+65','len':8,
    ...
    'ID': {'name':'Indonesia','flag':'🇮🇩','phone_code':'+62','len':10,
    ...
    'PH': {'name':'Philippines','flag':'🇵🇭','phone_code':'+63','len':10,
    ...
    'AE': {'name':'United Arab Emirates','flag':'🇦🇪','phone_code':'+971','len':9,
    ...
    'SA': {'name':'Saudi Arabia','flag':'🇸🇦','phone_code':'+966','len':9,
    ...
    'TR': {'name':'Turkey','flag':'🇹🇷','phone_code':'+90','len':10,
    ...
    'RU': {'name':'Russia','flag':'🇷🇺','phone_code':'+7','len':10,
    ...
    'UA': {'name':'Ukraine','flag':'🇺🇦','phone_code':'+380','len':9,
    ...
    'BR': {'name':'Brazil','flag':'🇧🇷','phone_code':'+55','len':11,
    ...
    'MX': {'name':'Mexico','flag':'🇲🇽','phone_code':'+52','len':10,
    ...
    'AR': {'name':'Argentina','flag':'🇦🇷','phone_code':'+54','len':10,
    ...
    'CL': {'name':'Chile','flag':'🇨🇱','phone_code':'+56','len':9,
    ...
    'CO': {'name':'Colombia','flag':'🇨🇴','phone_code':'+57','len':10,
    ...
    'PE': {'name':'Peru','flag':'🇵🇪','phone_code':'+51','len':9,
    ...
    'ZA': {'name':'South Africa','flag':'🇿🇦','phone_code':'+27','len':9,
    ...
    'NG': {'name':'Nigeria','flag':'🇳🇬','phone_code':'+234','len':10,
    ...
    'KE': {'name':'Kenya','flag':'🇰🇪','phone_code':'+254','len':9,
    ...
    'EG': {'name':'Egypt','flag':'🇪🇬','phone_code':'+20','len':10,
    ...
    'MA': {'name':'Morocco','flag':'🇲🇦','phone_code':'+212','len':9,
...
COUNTRY_ALIASES = {
    'USA':'US','UK':'GB','ENGLAND':'GB','BRITAIN':'GB','UNITED STATES':'US','AMERICA':'US',
    'UNITED KINGDOM':'GB','CAN':'CA','CANADA':'CA','AUS':'AU','AUSTRALIA':'AU','GERMANY':'DE',
    'DEUTSCHLAND':'DE','FRANCE':'FR','ITALY':'IT','ITALIA':'IT','SPAIN':'ES','ESPANA':'ES',
    'NETHERLANDS':'NL','HOLLAND':'NL','SWEDEN':'SE','NORWAY':'NO','DENMARK':'DK','FINLAND':'FI',
    'IRELAND':'IE','PORTUGAL':'PT','POLAND':'PL','INDIA':'IN','IND':'IN','BHARAT':'IN',
    'PAKISTAN':'PK','BANGLADESH':'BD','CHINA':'CN','JAPAN':'JP','KOREA':'KR','SOUTH KOREA':'KR',
    'THAILAND':'TH','VIETNAM':'VN','MALAYSIA':'MY','SINGAPORE':'SG','INDONESIA':'ID',
    'PHILIPPINES':'PH','UAE':'AE','EMIRATES':'AE','SAUDI':'SA','SAUDI ARABIA':'SA','KSA':'SA',
    'TURKEY':'TR','TURKIYE':'TR','RUSSIA':'RU','UKRAINE':'UA','BRAZIL':'BR','BRASIL':'BR',
    'MEXICO':'MX','ARGENTINA':'AR','CHILE':'CL','COLOMBIA':'CO','PERU':'PE','SOUTH AFRICA':'ZA',
    'NIGERIA':'NG','KENYA':'KE','EGYPT':'EG','MOROCCO':'MA','DUBAI':'AE',
}


def _resolve_country(code):
    code = (code or '').strip().upper()
    if code in FAKE_DATA:
        return code
    return COUNTRY_ALIASES.get(code)


def _gen_phone_fake(code):
    d = FAKE_DATA[code]
    n = d['len']
    if code in ('US', 'CA'):
...
async def cmd_fake(event):
    ...
    if not arg or arg.lower() == 'list':
        ...
        half = (len(codes) + 1) // 2
        left  = "  ".join(f"{FAKE_DATA[c]['flag']}<code>{c}</code>" for c in codes[:half])
        right = "  ".join(f"{FAKE_DATA[c]['flag']}<code>{c}</code>" for c in codes[half:])
        await styled_reply(event, pe(f"""🌍 <b>{bs('Fake Identity Generator')}</b>
{SEP}
{bs('Countries')} (<code>{len(codes)}</code>):
...
<code>/fake list</code>"""))
    ...
    if arg.lower() == 'random':
        ...
        code = _resolve_country(arg)
        if not code:
            return await styled_reply(event, pe(
                f"❌ <b>{bs('Unknown country')}</b>: <code>{arg}</code>\n"
                f"💡 {bs('Use')} <code>/fake list</code> {bs('to see all')}"
            ))
    ...
    street = f"{random.randint(1, 9999)} {random.choice(d['streets'])}"
    phone = _gen_phone_fake(code)
    clean_first = first.lower().replace(' ', '').replace("'", "")
    clean_last  = last.lower().replace(' ', '').replace("'", "")
    email = f"{clean_first}.{clean_last}{random.randint(1, 999)}@example.com"

    await styled_reply(event, pe(f"""🌍 <b>{bs('Fake Identity')}</b> — {d['flag']} <b>{d['name']}</b>
{SEP}
👤 <b>{bs('Name')}</b> {first} {last}
🏠 <b>{bs('Street')}</b> {street}
🏙 <b>{bs('City')}</b> {city}
🗺 <b>{bs('State')}</b> {state}
🌐 <b>{bs('Country')}</b> {d['name']}
📮 <b>{bs('Zip')}</b> {zip_c}
📞 <b>{bs('Phone Number')}</b> {phone}
📧 <b>{bs('Email')}</b> <code>{email}</code>
{SEP}
💡 <code>/fake {code}</code> · <code>/fake random</code> · <code>/fake list</code>"""))
...
# ====================== EXTRA RANDOM HELPERS ======================
@client.on(events.NewMessage(pattern=r'^[/.]pass(?:\s+(\d+))?$'))
async def cmd_pass(event):
    ...
    if m:
        try: length = max(6, min(128, int(m)))
        except: pass
    alphabet = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^&*()-_=+"
    pw = ''.join(random.choice(alphabet) for _ in range(length))
    await styled_reply(event, pe(f"🔑 <b>{bs('Random Password')}</b>\n{SEP}\n<code>{pw}</code>\n{SEP}\n{bs('Length')}: <code>{length}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]uuid$'))
async def cmd_uuid(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    val = str(_uuid_lib.uuid4())
    await styled_reply(event, pe(f"🆔 <b>{bs('UUID v4')}</b>\n{SEP}\n<code>{val}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]short\s+(.+)$'))
async def cmd_short(event):
    ...
    try:
        ...
        await styled_reply(event, pe(f"🔗 <b>{bs('Shortened URL')}</b>\n{SEP}\n<b>{bs('Original')}</b>: <code>{url}</code>\n<b>{bs('Short')}</b>: <code>{short}</code>"))
    except Exception as e:
        await styled_reply(event, pe(f"❌ <code>{e}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]ua$'))
async def cmd_ua(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    uas = [
    ...
    await styled_reply(event, pe(f"💻 <b>{bs('User-Agent')}</b>\n{SEP}\n<code>{ua}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]mac$'))
async def cmd_mac(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    mac = ':'.join(f"{random.randint(0,255):02X}" for _ in range(6))
    await styled_reply(event, pe(f"🖥 <b>{bs('Random MAC')}</b>\n{SEP}\n<code>{mac}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]cc\s+(\d{13,19})$'))
async def cmd_cc_luhn(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    cc = event.pattern_match.group(1)
    def _luhn(card):
        d = [int(x) for x in card]
        s = 0
        ...
        return s % 10 == 0
    ok = _luhn(cc)
    await styled_reply(event, pe(f"💳 <b>{bs('Luhn Check')}</b>\n{SEP}\n<code>{cc}</code>\n{bs('Valid')}: {'✅' if ok else '❌'}"))


@client.on(events.NewMessage(pattern=r'^[/.]email(?:\s+(\S+))?$'))
async def cmd_email(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    name = (event.pattern_match.group(1) or '').strip().lower().replace(' ', '.')
    if not name:
        name = random.choice(['john','jane','mike','sarah','david','emma','alex','sam'])
    domain = random.choice(['example.com','mail.com','test.com','inbox.net','gmail.com'])
    await styled_reply(event, pe(f"📧 <b>{bs('Random Email')}</b>\n{SEP}\n<code>{name}{random.randint(1,999)}@{domain}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]phone(?:\s+([A-Za-z]+))?$'))
async def cmd_phone(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    arg = (event.pattern_match.group(1) or '').strip()
    code = _resolve_country(arg) if arg else random.choice(list(FAKE_DATA.keys()))
    if not code: code = 'US'
    phone = _gen_phone_fake(code)
    await styled_reply(event, pe(f"📞 <b>{bs('Random Phone')}</b> — {FAKE_DATA[code]['flag']} <b>{FAKE_DATA[code]['name']}</b>\n{SEP}\n<code>{phone}</code>"))


@client.on(events.NewMessage(pattern=r'^[/.]name(?:\s+([A-Za-z]+))?$'))
async def cmd_name(event):
    ...
    if not code: code = 'US'
    d = FAKE_DATA[code]
    await styled_reply(event, pe(f"👤 <b>{bs('Random Name')}</b> — {d['flag']} <b>{d['name']}</b>\n{SEP}\n{random.choice(d['first'])} {random.choice(d['last'])}"))
...
async def cmd_mystats(event):
    ...
    proxies = load_user_proxies(uid)
    rank = load_rank()
    charges = int(rank.get(str(uid), 0))
    try:
        sender = await event.get_sender()
        username = f"@{sender.username}" if sender.username else f"<a href='tg://user?id={uid}'>{sender.first_name}</a>"
    except:
        username = f"<code>{uid}</code>"
    await styled_reply(event, pe(f"""📊 <b>{bs('My Stats')}</b>
{SEP}
👤 {username}
🆔 <code>{uid}</code>
💎 {bs('Premium')}: {'✅' if premium else '❌'}
🔌 {bs('Proxies')}: <code>{len(proxies)}</code>
💳 {bs('Charges')}: <code>{charges}</code>"""))
...
async def cmd_top(event):
    ...
    rank = load_rank()
    if not rank:
        return await styled_reply(event, pe(f"{PE} {bs('No charge data yet.')}"))
    top = sorted(rank.items(), key=lambda x: int(x[1]), reverse=True)[:10]
    lines = []
    for i,(uid_s,cnt) in enumerate(top,1):
        try:
            ent = await client_instance.get_entity(int(uid_s))
            nm = ent.first_name or uid_s
        except: nm = uid_s
        lines.append(f"{i}. <b>{nm}</b> — <code>{cnt}</code>")
    await styled_reply(event, pe(f"🏆 <b>{bs('Top 10 Chargers')}</b>\n{SEP}\n" + "\n".join(lines)))


@client.on(events.NewMessage(pattern=r'^[/.]timezone(?:\s+(.+))?$'))
async def cmd_timezone(event):
    uid = event.sender_id
    if is_banned(uid): return
    if not await force_join_check(event): return
    tz_map = {
        'new york': -5, 'nyc': -5, 'los angeles': -8, 'la': -8, 'chicago': -6,
        'london': 0, 'paris': 1, 'berlin': 1, 'madrid': 1, 'rome': 1,
        'istanbul': 3, 'moscow': 3, 'dubai': 4, 'karachi': 5, 'delhi': 5.5,
        'mumbai': 5.5, 'dhaka': 6, 'bangkok': 7, 'singapore': 8, 'tokyo': 9,
        'seoul': 9, 'sydney': 11, 'sao paulo': -3, 'mexico city': -6,
        'cairo': 2, 'johannesburg': 2, 'lagos': 1, 'nairobi': 3,
    }
    arg = (event.pattern_match.group(1) or '').strip().lower()
    if not arg:
        lines = [f"{k.title()}: <code>{(datetime.utcnow()+timedelta(hours=v)).strftime('%H:%M')}</code>"
                 for k,v in list(tz_map.items())[:15]]
        await styled_reply(event, pe(f"🕐 <b>{bs('World Times (UTC)')}</b>\n{SEP}\n" + "\n".join(lines)))
        return
    if arg in tz_map:
        t = datetime.utcnow() + timedelta(hours=tz_map[arg])
        await styled_reply(event, pe(f"🕐 <b>{arg.title()}</b>: <code>{t.strftime('%Y-%m-%d %H:%M:%S')}</code> UTC{tz_map[arg]:+g}"))
    else:
        await styled_reply(event, pe(f"❌ {bs('Unknown city. Try')}: <code>/timezone london</code>"))
...
async def cmd_split(event):
    ...
    if uid not in ADMIN_ID and not is_premium(uid):
        return await send_premium_only(event)
    if not event.reply_to_msg_id:
        return await styled_reply(event, pe(f"💎 {bs('Reply to a .txt')}"))
    reply = await event.get_reply_message()
    if not reply or not reply.file:
        return await styled_reply(event, pe(f"💎 {bs('Reply to a .txt')}"))
    try:
    ...
    if not lines:
        return await styled_reply(event, pe(f"💎 <b>{bs('Empty')}</b>"))
    ...
    await styled_reply(event, pe(
        f"💎 <b>{bs('Split')}</b>\n{SEP}\n📁 <code>{len(lines)}</code>\n"
        f"💡 {bs('Select chunk size')}:"), buttons=buttons)


@client.on(events.CallbackQuery(pattern=rb"^split_size:(\d+):(\d+)$"))
async def cb_split_size(event):
    m = event.pattern_match
    size = int(m.group(1).decode()); uid = int(m.group(2).decode())
    ...
    await event.edit(pe(f"💎 {bs('Splitting')} <code>{len(chunks)}</code>..."), parse_mode='html')
    for i, ch in enumerate(chunks, 1):
        ...
        async with aiofiles.open(fname, 'w', encoding='utf-8') as f:
            for ln in ch:
                await f.write(ln + "\n")
        await client_instance.send_file(uid, fname,
            caption=pe(f"📁 {bs('Part')} {i}/{len(chunks)} ({len(ch)} lines)"), parse_mode='html')
        os.remove(fname)
    await event.edit(pe(f"✅ {bs('Done')} — <code>{len(chunks)}</code>"), parse_mode='html')
    await event.answer("Sent!", alert=False)
...
{SEP}
🛒 <b>Shopify</b>
<code>/sh card|mm|yy|cvv</code> · <code>/msh</code>
{SEP}
🔴 <b>RazorPay</b>
<code>/rz card|mm|yy|cvv</code> · <code>/mrz</code>
{SEP}
🛑 <code>/stop</code> · 📊 <code>/rank</code>""")
    await event.edit(text, buttons=[[pbtn(bs("🔙 Back"), data="main_menu")]],
                     parse_mode='html', link_preview=False)
...
{SEP}
<code>/addsites</code> · <code>/site</code>
<code>/rm site.com</code> · <code>/rm all</code>
<code>/getsites</code>
...
👤 <code>/fake US</code> · <code>/fake list</code> · <code>/fake random</code>
📡 <code>/ip 8.8.8.8</code>
🏦 <code>/iban GB82WEST...</code>
{SEP}
🎲 <b>{bs('Random Generators')}</b>
<code>/pass [len]</code> · <code>/uuid</code>
<code>/email [name]</code> · <code>/phone [CC]</code> · <code>/name [CC]</code>
<code>/ua</code> · <code>/mac</code> · <code>/cc &lt;num&gt;</code> · <code>/short &lt;url&gt;</code>
<code>/timezone [city]</code> · <code>/mystats</code> · <code>/top</code>
{SEP}
...
{SEP}
<code>/status</code> · <code>/stats</code>
<code>/ping</code> · <code>/toggle</code>
<code>/rank</code>""")
    await event.edit(text, buttons=[[pbtn(bs("🔙 Back"), data="main_menu")]],
                     parse_mode='html', link_preview=False)
...
🎬 <code>/listhitvideos</code> · <code>/removehitvideo N</code>
🎬 <code>/hitvideo</code>""")
    await event.edit(text, buttons=[[pbtn(bs("🔙 Back"), data="main_menu")]],
                     parse_mode='html', link_preview=False)
