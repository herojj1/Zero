# =============================================================================
# NOVA Bot — Complete Single-File Source (v5.0.0)
# =============================================================================
        ...
        try:
            if attach_referral(event.sender_id, ref_code):
                await styled_reply(event, pe(
                    ...
                    f"✅ {bs('You joined via a friend\\'s invite')}\n"
...
async def cmd_diag(event):
    ...
    lines.append(f"📦 Version: <code>v5.0.0</code>")
...
async def main():
    ...
    log_system("BOOT", "Starting NOVA bot v5.0.0 (API-LESS)...")
