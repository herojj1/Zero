# =============================================================================
# NOVA Bot — Complete Single-File Source (v4.0.1)
# =============================================================================
# Changelog v4.0.1:
#   - SHOPIFY_API_URL default set to your working API (f49a)
#   - test_site_with_price test card switched to API-accepted card
#   - /addsites now works end-to-end
# =============================================================================
...
# ★★★ FIX 1: point to YOUR working API ★★★
...
async def cmd_sh(event):
    ...
    if not await _check_free_or_premium(event, uid):
        return
    # Per-user daily limit (premium only, non-admin)
...
async def test_site_with_price(site: str, proxy: str = None) -> dict:
    ...
    """
    # ★★★ FIX 2: use a test card the API accepts ★★★
...
async def _run_site_tests(event, uid, to_test, status_msg, initial_sites_count, existing=None, wipe=False):
    ...
    try:
        ...
        # Abort only if MAJORITY of results are proxy errors
...
async def main():
    ...
    try:
        ...
        pass
    log_system("BOOT", "Starting NOVA bot v4.0.1...")
    if not BOT_TOKEN:
